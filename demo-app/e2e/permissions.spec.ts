...
test.describe('Authorization & Permissions', () => {
  ...
  test('should create custom role', async ({ page }) => {
    ...
    await page.getByRole('textbox', { name: /role name/i }).fill('project-manager');
    await page.getByRole('textbox', { name: /description/i }).fill('Manages projects and teams');
  ...
  test('should grant role to user', async ({ page }) => {
    ...
    await page.getByRole('combobox', { name: /select role/i }).selectOption('org:admin');
  ...
  test('should prevent unauthorized access', async ({ page, context }) => {
    ...
    await page.getByRole('textbox', { name: /password/i }).fill(regularUser.password);
    await page.getByRole('button', { name: /sign in/i }).click();
  ...
  test('should show permission inheritance', async ({ page }) => {
    ...
    await page.getByRole('combobox', { name: /inherits from/i }).selectOption('team-lead');
  ...
  test('should search for users', async ({ page }) => {
    ...
    // Search for user
    await page.getByRole('textbox', { name: /search users/i }).fill(regularUser.email);
